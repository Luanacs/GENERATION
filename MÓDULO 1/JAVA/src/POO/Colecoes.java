...
public class Colecoes {
	...
	public static void main(String[] args) {
		...
		minhaLista.add(2); //add irá adicionar um elemento ao meu array list
		minhaLista.add(5);
		minhaLista.add(2);
		minhaLista.add(1);
		minhaLista.add(6);
		...
		Collections.sort(minhaLista); //Collections é minha interface // sort ordena os elementos dentro de uma lista automaticamente
